		   		...
		   		<div class="textData">
					...
					<h4>{$item.twitter_title}</h4>
		   			...
		   			<div class="buttons">
						...
						<span class="dayComment"><a class="btn btn-mini" title="评论" href="{#public#}response/index?id={$item.twitter_id}"><i class="icon-comment"></i><span>{$item.twitter_comment}</span></a></span>

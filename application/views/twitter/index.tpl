	...
	<div class="row-fluid">
		...
		<hr id="specialHr"/>
				<div class="pagination pagination-centered">
					<ul >
						<li><a href="http://www.days366.com/twitter/findday?month={$preLastMonth}&day={$preYesterday}">&larr; 前天</a></li>
						<li><a href="http://www.days366.com/twitter/findday?month={$lastMonth}&day={$yesterday}">&larr; 昨天</a></li>
						<li><a href="http://www.days366.com/twitter/findday?month={$month}&day={$day}">今天</a></li>
					</ul>
				</div>		
		<div class="result">
			...
			<div class="resultTextData" data="{$item.twitter_id}">
		   		<div class="textData">
					...
					<h4>{$item.twitter_title}</h4>
		   			...
		   			{/if}
		   			<div class="buttons">
						<span class="dayLike"><button class="btn btn-mini" title="喜欢"><i class="icon-heart"></i>&nbsp;<span>{$item.twitter_like}</span></button></span>
						<span class="dayFavourite"><button  class="btn btn-mini" title="收藏"><i class="icon-plus-sign"></i>&nbsp;<span>{$item.twitter_favourite}</span></button></span>
						<span class="dayComment"><a href="{#public#}response/index?id={$item.twitter_id}" title="评论" class="btn btn-mini"><i class="icon-comment"></i>&nbsp;<span>{$item.twitter_comment}</span></a></span>
